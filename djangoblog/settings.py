...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DJANGO_MYSQL_DATABASE') or 'railway',
        'USER': os.environ.get('DJANGO_MYSQL_USER') or 'root',
        'PASSWORD': os.environ.get('DJANGO_MYSQL_PASSWORD') or 'wRFJgxoqjJPBWsRPIcjFAexSkKQmwDSR',
        'HOST': os.environ.get('DJANGO_MYSQL_HOST') or 'mysql.railway.internal',
        'PORT': int(
